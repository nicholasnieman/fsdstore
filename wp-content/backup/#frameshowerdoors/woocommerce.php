...
if ($_SERVER['REQUEST_URI'] == "/builder/" && is_page(11801) && is_page( 'builder' ) ) {
	...
	get_template_part( 'kiosk/dummykiosk', 'product' );
}
		            ...
		            <div class="col-main">
		                <div class="page_cont">
		                    ...
		                    <p class="availability">
		                    	Availability: <span><?php echo $product->is_in_stock() ? 'InStock' : 'OutOfStock'; ?></span>
		                   	</p>
							...
							<div class="more-views">
								...
								<ul>
								  	<li>
								    	<a class="fancyimg" title="" rel="lbx" class="fancy" href="<?php echo $image_url[0]; ?>">
								        	<img width="56" height="56" alt="" src="<?php echo $image_url[0]; ?>" itemprop="image">
								    	</a>
								  	</li>
								</ul>
							</div>
		                                ...
		                                if($mainopt_key ){
		                                    ...
		                                    foreach ( $final_arr_val as $final_arrkey => $final_arr_value ) {
												...
												if( (!$max_price) || ($max_price == $min_price)){
													echo '<option value="'.$final_arr_value.'"> '.$final_arr_value.': $'.$min_price.'</option>';
												}
												else{
													echo '<option value="'.$final_arr_value.'"> '.$final_arr_value.': $'.$min_price.' to $'.$max_price.'</option>';
												}
		                                    }
							...
							?>
		                  	...
		                  	<div id="product-options-bottom" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
