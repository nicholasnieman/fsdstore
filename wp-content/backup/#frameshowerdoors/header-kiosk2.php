...
.selectionbk2 .mains {width:100% !important}
...
<div class="header_area">
			...
			<div class="col-md-6">
			  <a href="https://www.framelessshowerdoors.com/index/"><img src="/wp-content/uploads/2016/08/KioskFrameless_logo.png" width="70%" alt="Logo" ></a>
			  <p >America's only direct from the manufacturer frameless <br>shower door company.</p>
			</div></div></div>
			<div class="col-md-5 col-md-offset-1" >
				<div style="width:60%;  margin:28px auto;  font-size:16px; text-align:center;  line-height:20px; background:#026267; padding:15px;"><a style="color:#fff; font-weight:700; text-decoration:none;" href="<?php echo site_url().$builddoor_url; ?>"><i class="fa fa-hand-pointer-o"></i>
&nbsp; 
