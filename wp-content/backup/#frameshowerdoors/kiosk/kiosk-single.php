...
/*Getting Username*/
	if($framework == 'kiosk' || $framework == 'kiosk/'){
		...
		$mode_type = 'Kiosk';
		$form_redirect_url =  site_url().'/main-thank-you/';
	}
...
?>
	...
	<div id="get_modal" class="get_modal" style="display:none;">
	  	<center>
	          ...
	          <h1>STAY<strong>CLEAN</strong>&#8482;</h1>
	          	...
	          	<div id="stay_clean_glass" class="col-xs-12 stc-option" style="text-align:center">
	              	<div class="row option-text" style="text-align:center !important">
	                  	<span>
	                      	...
	                      	<br>Add
	                      	water and stain resistant glass NOW for only $<span id="coating-price-defined"><?php echo $resistant_coating; ?></span>
	                      	<center>
			                        ...
			                        <ul class="bundle-tild-sect">
			                        	<?php
			                          	foreach ($glass_thickness as $key => $value) {
			                                ...
			                                <label>
			                                   <a data-re_keyname="glass_thickness" data-show_keyname="Glass Thickness" title="'.$value.'" data-me_nextrel="attribute-option-3" data-re_dependence="glass_type"  data-rel="attribute-option-3" dat-cur-rel="attribute-option-2" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" style="width: 300px; padding:20px;" />
			                                   </a>
			                                  <a class="btn-v-tild" data-re_keyname="glass_thickness" data-show_keyname="Glass Thickness" title="'.$value.'" data-me_nextrel="attribute-option-3" data-re_dependence="glass_type"  data-rel="attribute-option-3" dat-cur-rel="attribute-option-2" rel="'.$value.'" style="width: 300px; padding:20px;">
		                        ...
		                        <ul class="bundle-tild-sect" style="padding:0px !important">
		                          	...
		                          	foreach ($gls_type_order as $key => $value) {
		                                ...
		                                <label >
		                                   ...
		                                   <a class="btn-v-tild" data-re_keyname="glass_type" data-show_keyname="Glass Type" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="attribute-option-4" dat-cur-rel="attribute-option-3" rel="'.$value.'" style="width:100% !important; margin-left: -9px; margin-top:-4px;"><span class="post-title-sect coName">'.$value.'</span></a>
		                                </label></li>';
			                                ...
			                                foreach ($hinge_style as $key => $value) {
			                                    ...
			                                    if($check_pull == 'on'){
			                                       $hinge_style_html .= '<li class="glass-type" style="display:none;">
			                                          <label>
			                                             <a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-6" dat-cur-rel="attribute-option-5" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" style="width: 100%; padding:20px;"  />
			                                             </a>
			                                             <a class="btn-v-tild" data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-6" dat-cur-rel="attribute-option-5" rel="'.$value.'" style="width:90% !important"><span class="post-title-sect coName" >'.$value.'</span></a>
			                                          </label></li>';
			                                    }
			                                    else{
			                                        if($check_towelbar == 'on'){
														$hinge_style_html .= '<li class="glass-type" style="display:none;">
														<label>
														 <a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-5" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" style="width: 100%; padding:20px;" />
														 </a>
														<a class="btn-v-tild" data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-5" rel="'.$value.'" style="width:90% !important"> <span class="post-title-sect coName">'.$value.'</span></a>
														</label></li>';
			                                        }
			                                        else{
														$hinge_style_html .= '<li class="glass-type" style="display:none;">
														<label>
														<a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-5" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" style="width: 100%; padding:20px;" />
														</a>
														<a class="btn-v-tild" data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-5" rel="'.$value.'" style="width:90% !important"> <span class="post-title-sect coName">'.$value.'</span></a>
														</label></li>';
			                                        }    
			                                    }
			                                }
  ...
  <tbody>
  <tr>
      <td  style="background:none; padding:10px !important;" colspan="3"><div style="color:#333333; font-weigh:bold;"><strong style="color:#333333 !important; font-size:14px !important; ">ALL HINGES FOR 3/8" THICK GLASS</strong></div></td>
    
    </tr>
    <tr>
      <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">Maximum Capacities</td>
     <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">1/2" (10 MM) Glass <BR>WEIGHT</td>
      <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">3/8" (10 MM) Glass<br>DOOR WIDTH</td>
    </tr>
    <tr>
      <td style="color:#333333; background:#ffffff;padding:4px !important;  font-size:14px;">Using Two Hinges</td>
     <td style="color:#333333;background:#ffffff; padding:4px !important; font-size:14px;">80 lbs/36 kg</td>
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">28"/711 mm</td>
    </tr>
    <tr>
      <td style="color:#333333;padding:4px !important; background:#d2e2e3;  font-size:14px;">Using Three Hinges</td>
     <td style="color:#333333;padding:4px !important; background:#d2e2e3;  font-size:14px;">120 lbs/54 kg</td>
     <td style="color:#333333; padding:4px !important; background:#d2e2e3; font-size:14px;">32"/812 mm</td>
    </tr>
  </tbody>
</table>
<p><br></p>
...
<table width="100%" border="0" cellspacing="0" style="font-size:12px !important" >
  ...
  <tr>
    ...
    <tr>
      <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">Maximum Capacities</td>
     <td colspan="2" style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">1/2" (10 MM) Glass</td>

        <td  colspan="2" style="background:#999999; padding:4px !important;  font-weight:bold; color:#ffffff;">3/8" (10 MM) Glass - Oversize</td>
    </tr>
    ...
    <tr>
      <td style="color:#333333; background:#ffffff;padding:4px !important;  font-size:14px;">Using Two Hinges</td>
     <td style="color:#333333;background:#ffffff; padding:4px !important; font-size:14px;">110lbs/50 kg</td>
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">36"/914 mm</td>
     
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">110 lbs/50 kg</td>
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">36"/914 mm</td>
    ...
    <tr>
      <td style="color:#333333;padding:4px !important; background:#d2e2e3;  font-size:14px;">Using Three Hinges</td>
     <td style="color:#333333;padding:4px !important; background:#d2e2e3;  font-size:14px;">140 lbs/63 kg</td>
     <td style="color:#333333; padding:4px !important; background:#d2e2e3; font-size:14px;">36"/914 mm</td>
     <td style="color:#333333;padding:4px !important; background:#d2e2e3;  font-size:14px;">140 lbs/63 kg</td>
     <td style="color:#333333; padding:4px !important; background:#d2e2e3; font-size:14px;">36"/914 mm</td>
    </tr>
  </tbody>
...
<p><br></p>
 ...
 <table width="100%" border="0" cellspacing="0" style="font-size:12px !important">
  ...
  <tr>
     ...
     <tr>
      <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">Maximum Capacities</td>
     <td colspan="2" style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">3/8" (10 MM) Glass</td>
    ...
    <tr>
      <td style="color:#333333; background:#ffffff;padding:4px !important;  font-size:14px;">Using Two Hinges</td>
     <td style="color:#333333;background:#ffffff; padding:4px !important; font-size:14px;">100 lbs/45 kg</td>
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">31"/787 mm</td>
    </tr>
 ...
 <p><br></p> 
  ...
  <tr>
     ...
     <tr>
      <td style="background:#999999; padding:4px !important; font-weight:bold; color:#ffffff;">Maximum Capacities</td>
     <td colspan="2" style="background:#999999; padding:4px !important; font-weight:bold;  color:#ffffff;">1/2" (12 MM) Glass</td>
    ...
    <tr>
     ...
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">36"/914 mm</td>
                 ...
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
			                       ...
			                       <ul class="bundle-tild-sect" > 
										<li style="margin-top:30px !important;">
											<label style="width:100% !important">
												<a data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-7" dat-cur-rel="attribute-option-6" rel="" data-re_attr="knob" style="text-align:center !important; margin-bottom:55px;"><img src="<?php echo get_template_directory_uri(); ?>/images/bundled/knobkiosk.png" id="knob-attribute-style" style="width:180px !important; height:auto;" />Knob 
												</a>
												<a class="btn-v-tild" id="knob-attribute-style_a" class="btn-v-tild" data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-7" dat-cur-rel="attribute-option-6" rel="" data-re_attr="knob" style="width:250px !important">
										...
										<li class="pull-type" style="margin-top:40px !important;">
										 	<label>
										    	<a data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-8" dat-cur-rel="attribute-option-6" rel="" style="text-align:center !important; margin-bottom:55px;"><img src="<?php echo get_template_directory_uri(); ?>/images/bundled/handlekiosk.png" id="handle-attribute-style" style="width:200px !important; height:auto;"/>Handle
										    	</a>
										    	<a class="btn-v-tild" data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-8" dat-cur-rel="attribute-option-6" rel="" style="width:250px !important">
										...
										<li class="pull-type" style="margin-top:40px !important;" >
										 	<label>
										    	<a data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-10" dat-cur-rel="attribute-option-6" rel="" style="text-align:center !important; margin-bottom:55px;"><img src="<?php echo get_template_directory_uri(); ?>/images/bundled/towelbarcomboKiosk.png" id="towelbar-attribute-style" style="width:320px !important; height:auto;" />Towel Bar
										   		</a>
										    	<a class="btn-v-tild" data-rel-last="attribute-option-6" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="attribute-option-10" dat-cur-rel="attribute-option-6" rel="" style="width:250px !important">
		                ...
		                <!-- Pull Section knob -->
		                <div id="attribute-option-7" data-spec-id="attribute-option-6" class="atribut-pull_style field-_attribute_tag attribute-knob_style build-showerdoor atribut-pull_h knob_style" data-re_attr="knob"><div style="height:965px !important; ">
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
		                    <div class="col-xs-12">
	  		                            ...
	  		                            foreach ($knob_style as $key => $value) {
	  		                              	...
	  		                              	if($check_towelbar == 'on'){
	  			                                ...
	  			                                <label style="background:#ffffff; width:250px !important; padding-top:10px;">
	  			                                  ...
	  			                                  <a class="btn-v-tild" data-re_keyname="knob_style" data-show_keyname="Knob Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-7" rel="'.$value.'" style="width:250px !important;">
	  			                                ...
	  			                                <label style="background:#ffffff; width:250px !important; padding-top:10px;">
	  			                                  ...
	  			                                  <a class="btn-v-tild" data-re_keyname="knob_style" data-show_keyname="Knob Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-7" rel="'.$value.'" style="width:250px !important;">
	  			                                    <span class="post-title-sect coName">'.$value.'</span>
	  			                                  </a>
	  			                                </label></li>';
	  		                              	}
		                 ...
		                 <div id="attribute-option-8" data-spec-id="attribute-option-6" class="atribut-pull_style field-_attribute_tag attribute-handle_size build-showerdoor atribut-pull_h handle_size"><div style="height:975px !important; overflow-y:hidden !important;">
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
		                    <div class="col-xs-12">
		                        ...
		                        if($handle_size){
			                        foreach ($handle_size as $key => $value) {
			                            ...
			                            <label>
			                               <a data-re_keyname="handle_size" data-show_keyname="Handle Style" title="'.$value.'" data-rel="attribute-option-9" dat-cur-rel="attribute-option-8" rel="'.$value.'" >'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/kiosk/'.$src.'.png" style="width:260px !important; max-height:400px !important;" />
			                               </a>
										...
										foreach ($handle_style as $key => $value) {
											...
											if($check_towelbar == 'on'){
											   ...
											   <label style="background:#ffffff; width:240px !important; padding-top:10px;">
											        ...
											        <a class="btn-v-tild" data-re_keyname="handle_style" data-show_keyname="Handle Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-9" rel="'.$value.'" style="width:240px !important;">
											          <span class="post-title-sect coName">'.$value.'</span>
											        </a>  
										    	</label></li>';
										  	}
											    ...
											    <label style="background:#ffffff; width:240px !important; padding-top:10px;">
											        ...
											        <a class="btn-v-tild" data-re_keyname="handle_style" data-show_keyname="Handle Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-9" rel="'.$value.'" style="width:240px !important;">
											          <span class="post-title-sect coName">'.$value.'</span>
											        </a>  
											    </label></li>';
										  	}
                           ...
                           <h1>Combo Handle Size</h1>
                            <div class="col-xs-6" >
		                       ...
		                       <ul class="bundle-tild-sect">
		                            ...
		                            if($combo_handle_size){
			                            foreach ($combo_handle_size as $key => $value) {
			                               $src = strtolower( trim( preg_replace('/\s+/', '', $value ), '.') ); 

			                               $combo_handle_size_html .= '<li class="combo_handle_size" style="display:block; width:100%">
			                                  <label>
			                                    <a data-re_keyname="combo_handle_size" data-show_keyname="Combo Handle Size" title="'.$value.'" data-rel="attribute-option-11" dat-cur-rel="attribute-option-10" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/kiosk/towel-'.$src.'.png" width="56%" />
			                                    </a>
                 ...
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
		                ...
		                <div id="attribute-option-12" class="att-tild-sect atribut-pull_style field-_attribute_tag attribute-towelbar_style build-showerdoor atribut-pull_h atribut-gls_h towelbar_style" data-re_attr="handle-towelbar-combo" style="background: rgba(153, 215, 219, 0) none repeat scroll 0 0 !important; ">
             			...
             			<div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div>
		                    <div class="col-xs-12">
		                       <h1>Choose Your Combo Towelbar Style </h1><div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">Some finishes displayed below may not appear to be the exact color you've chosen, rest assured all of your hardware and pull type will match the selected finish.</div>
		                        ...
		                        <ul class="bundle-tild-sect"  >
		                        	<?php
		                        	if($combo_habdle_towelbar_style){
			                            foreach ($combo_habdle_towelbar_style as $key => $value) {
			                             	$src = strtolower( trim( preg_replace('/\s+/', '', $value ), '.') ); 
			                                if($check_towelbar == 'on'){
			                                  $combo_habdle_towelbar_style_html .= '<li class="glass-type" style="display:none; ">
			                                    <label>
			                                        <a data-re_keyname="combo_style" data-show_keyname="Combo Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-12" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/towel-'.$src.'.png" style="width:265px !important; height:auto !important"  />
			                                        </a>
			                                        <a class="btn-v-tild" data-re_keyname="combo_style" data-show_keyname="Combo Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-12" rel="'.$value.'" style="width:265px !important; height:auto !important" >
			                                          <span class="post-title-sect coName">'.$value.'</span>
			                                        </a>
			                                    </label></li>';
			                                }
			                                  ...
			                                  $combo_habdle_towelbar_style_html .= '<li class="glass-type" style="display:none;">
												<label >
												    <a data-re_keyname="combo_style" data-show_keyname="Combo Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-12" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/towel-'.$src.'.png" style="width:265px !important; height:auto !important" />
												    </a>
												    <a class="btn-v-tild" data-re_keyname="combo_style" data-show_keyname="Combo Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-12" rel="'.$value.'" style="width:265px !important; height:auto !important">
												    <span class="post-title-sect coName">'.$value.'</span>
												    </a>
												</label></li>';
			                                }
		                            ...
		                            <ul class="bundle-tild-sect"><?php
		                                if($towelbar_side){
		                                    foreach ($towelbar_side as $key => $value) {
		                                        ...
		                                        <a class="btn-v-tild" data-re_keyname="towelbar_side" data-show_keyname="Sides" title="'.$value.'" data-rel="attribute-option-13d" dat-cur-rel="attribute-option-13c" rel="'.$value.'" style="margin-top:-7px;">
		                                          <span class="post-title-sect coName">'.$value.'</span>
		                                        </a>  
		                              	        </label></li>';
		                                    }
										...
										if($towelbar_style){
											foreach ($towelbar_style as $key => $value) {
												...
												$combo_towelbar_style_html .= '<li class="glass-type">
												 <label >
												<a data-re_keyname="towelbar_style" data-show_keyname="Towelbar Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-13d" rel="'.$value.'" style="background:#ffffff; width:240px !important; padding-top:10px;">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/htowelbar_style-'.$src.'.png" />
												</a>
												<a class="btn-v-tild" data-re_keyname="towelbar_style" data-show_keyname="Towelbar Style" title="'.$value.'" data-rel="attribute-option-13e" dat-cur-rel="attribute-option-13d" rel="'.$value.'" style="width:240px !important; margin-top:-7px;">
												<span class="post-title-sect coName">'.$value.'</span>
												</a>
												</label></li>';
											}
                 ...
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
		                        <div class="light-well well">                      
		                          	...
		                          	<h1 style="display:none!important; "><nobr>Thank you for building your shower door today.</nobr>
		                          	<span class="glasssqft-options">  Glass SQFT <small></small></span>
		                          	</h1>
		                          	
		                          		<h2 style="display:none!important; "><nobr>Total Material Price: <b>$</b><b id="price_total"></b></nobr></h2>

		                          		<div class="kiosk-dist-door" style="display: none;">
		                          			<div class="row">
										...
										<p style="text-align:center"><strong style="font-size:16px !important; line-height:24px; color:#295d62 !important">Simply fill out your info and your personal technician will contact you to review your quote and answer any questions you may have.</strong> <br><br>Once you've placed your order, we will send you an easy to follow measuring and installation video with printable instructions custom tailored to your shower door enclosure.  </p>
	...
	<p><br></p>										
							...
							<input type="text" name="first_name" id="first_name" style="background:#E4E4E4; border:1px solid #A2A1A1; height:40px !important; color:#000 !important;" placeholder="First Name" required="required"><br>
								...
								<input type="text" name="phone" id="phone" placeholder="Phone" style="background:#E4E4E4; border:1px solid #A2A1A1; height:40px !important; color:#000 !important;" required="required">
															...
															<select name="state" id="state" style="background:#E4E4E4 !important; width:100%;border:1px solid #A2A1A1; height:40px !important; color:#000 !important;" required>
											...
											<div class="install_content" style="margin-top:42px;">
