    ...
    <div class="top_bar">
      <div class="container">
        <div class="col-sm-6 col-md-6">
          <div class="flag_text"> <img class="navFlag" alt="shower doors, glass shower doors, shower enclosures frameless, frameless sliding shower doors prices, best frameless shower doors, buy shower doors, complete shower enclosure, custom glass shower, cleaning shower doors, where to buy shower doors, cheap shower doors, no frame shower doors" src="<?php echo get_template_directory_uri(); ?>/images/usa-header.png">
    ...
    <div class="main_header">
      <div class="container">
        <div class="col-sm-3 col-md-3">
          <div class="logo"> <a id="logo" href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name') ?>"> <img src="<?php echo get_template_directory_uri(); ?>/images/FramelessShowerDoors_logo.gif" /> </a> </div>
        </div>
