				...
				<div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">Note: Clear Glass is the most commonly used and least expensive glass.Clear Low-Iron Glass, Colored Glass, or any Textured or Obscured Glass are more expensive than traditional clear glass. Rain, Bubbles, Aquaview and Crepe only come in 3/8" thickness.</div>				
			                                    ...
			                                    if($check_pull == 'on'){
			                                       $hinge_style_html .= '<li class="glass-type" style="display:none;">
			                                        ...
			                                        if($check_towelbar == 'on'){
														$hinge_style_html .= '<li class="glass-type" style="display:none;">
														<label style="margin-top:40px !important;">
														 <a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-5" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" style="max-width:70% !important" />
														 </a>
		                ...
		                <div id="attribute-option-14" data-rel="recap" class="row setup-content_step recap build-showerdoor">
		                    ...
		                    <div class="form-left">
								 ...
								 <table id="discount-til-sect" style="display:none;">
											...
											<tr>
												<td align="center"><span>Discount: </span><span class="discounted_amt empty_sect">200</span>
													...
													<span class="discount_description_val empty_sect">Testing</span></td>
								...
								<input type="text" name="phone" id="phone" placeholder="Phone" style="background:#E4E4E4; border:1px solid #A2A1A1; height:40px !important; color:#000 !important;" required="required" class="input-filed">
															...
															<input type="submit" name="contactSubmit" value="Click" id="bun_submit">
														</form>
		                                          	</div>  
		                                        </div>
		                                      
												<!--<div id="img_section" class="atr">
													<div class="">
														<div class="fl2"><img src="<?php bloginfo('template_url'); ?>/images/arrow1.gif"></div>
														<div class="fl">
														  	<a class="screenshot" style="width: 100%;" rel="<?php bloginfo('template_url'); ?>/images/basic-kit-sm.jpg" title="Clear Low Iron">
														      	<img width="120" src="<?php bloginfo('template_url'); ?>/images/basic-kit-sm.jpg">
														  </a>
														</div>   
													</div>

													<div class="ins">
														Enter your info to get Your instant quote and <span class="red">FREE&nbsp;</span>Basic install kit<br><span class="small_text">*with your purchase</span>
													</div>
												</div>-->
		                                    </div>
											...
											<div class="install_content">
												...
												<center>
													<p> Thank you for choosing The Original Frameless Shower Doors, the only “Direct from the manufacturer” shower door company!<br> <span style="font-size: 26px;">(855) 372 6537</span></p>
													 <p>LOW FLAT RATE SHIPPING FOR MOST AREAS IN THE CONTINENTAL U.S. <br> <em>For limited access areas there will be an additional fee.</em><br>*See shipping under services for details </p>
												</center>
											</div>
										</div>
									</div>
