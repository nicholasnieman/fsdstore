...
<header class="header" id="header1">
    ...
    <div class="container">
        ...
        <div class="buttonSH" style="width:60%; float:right;  margin:28px auto;  font-size:16px; text-align:center;  line-height:20px; background:#026267; padding:15px;"> <a href="<?php echo site_url().$builddoor_url; ?>" style="color:#fff; font-weight:700; text-decoration:none;"><i class="fa fa-refresh"></i> CHANGE DOOR SELECTION</a></div>
      </div>
            </div>
  </div>
          <!-- Header Menu  Start-->
