...
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/kiosk/kioskfonts/css/font-awesome.min.css"  />
    ...
    'shift': [
      ...
      '{space} '
		...
		$('#fsd-doorbuilder-option-21-qty-0,#fsd-doorbuilder-option-21-qty-1, #fsd-doorbuilder-option-21-qty-2,#fsd-doorbuilder-option-21-qty-3,#fsd-doorbuilder-option-21-qty-4,#fsd-doorbuilder-option-21-qty-5,#fsd-doorbuilder-option-21-qty-6').keyboard({
			layout: 'custom',
			tabNavigation : true,
			noFocus : true,
			usePreview : false,
...
.circlef {position: absolute; left: -40px; width: 1075px; text-align: center;  }
	...
	<body id="kiosk_dummy" <?php body_class(); ?> background="#f9f9f9 !important">
...
<div class="header_area">
			...
			<div class="col-md-6">
			  ...
			  <p >America's only direct from the manufacturer frameless <br>shower door company.</p>
			</div></div></div>
			<div class="col-md-5 col-md-offset-1" >
				<div style="width:80%;  margin:28px auto;  font-size:22px; text-align:center;   background:#f4870b; border:1px solid #e67307; box-shadow: 3px 3px 5px #333333; padding:25px;"><a style="color:#fff; font-weight:700; text-decoration:none;" href="<?php echo site_url().$builddoor_url; ?>"><i class="fa fa-hand-pointer-o"></i>
&nbsp; 
 BUILD NEW DOOR</a></div>
