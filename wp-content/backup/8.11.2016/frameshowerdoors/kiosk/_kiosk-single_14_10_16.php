					...
					<div class="twoColbg" id="<?php echo get_the_id(); ?>">
						...
						<div class="col-sm-8">
							<div id="selected_opt" class="clearfix">
								<h3>Door Builder Progress</h3>
								<h6>To change your selection touch the links below.</h6>
								<!-- <div id="backNav" class="stepNav backNav btn btn-primary dark-btn">Back</div>
								<div style="display: inline-block; float: left;"><ol class="cd-breadcrumb triangle"></ol></div> -->
			                                    ...
			                                    if($check_pull == 'on'){
			                                       $hinge_style_html .= '<li class="glass-type" style="display:none;">
			                                        ...
			                                        if($check_towelbar == 'on'){
														...
														<label>
														 <a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="attribute-option-13a" dat-cur-rel="attribute-option-5" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/slidingdoorbundle/'.$src.'.png" style="width: 100%; padding:20px;" />
														 </a>
                 ...
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div> 
		                        <div class="light-well well">                      
		                          	...
		                          	<span class="glasssqft-options">  Glass SQFT <small></small></span>
										...
										<p style="text-align:center"><strong style="font-size:16px !important; line-height:24px; color:#295d62 !important">Enter your information below and receive your instant quote. </strong>  </p>
