	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-name"><?php _e( 'Product', 'claue' ); ?></th>
				<th class="product-price"><?php _e( 'Price', 'claue' ); ?></th>
				<th class="product-quantity"><?php _e( 'Quantity', 'claue' ); ?></th>
				<th class="product-subtotal"><?php _e( 'Total', 'claue' ); ?></th>
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); echo ' '.$product_bundle_class ?>">
								...
								?>
									...
									<td class="product-name" data-title="<?php _e( 'Product', 'claue' ); ?>">
										<?php
											if ( ! $product_permalink ) {
								...
								<?php else:?>
									<td class="product-name" data-title="<?php _e( 'Product', 'claue' ); ?>" colspan="2">
										<?php
											if ( ! $product_permalink ) {
												echo apply_filters( 'woocommerce_cart_item_name', $_product->get_name(), $cart_item, $cart_item_key ) . '&nbsp;';
											} else {
								...
								<td class="product-price" data-title="<?php _e( 'Price', 'claue' ); ?>">
									<?php
								...
								<?php
									if ( ! isset( $cart_item['bundle-parent'] ) ) :
								?>
									<td class="product-quantity" data-title="<?php _e( 'Quantity', 'claue' ); ?>">
										<?php
								...
								<?php endif;?>
								<td class="product-subtotal" data-title="<?php _e( 'Total', 'claue' ); ?>">
									<?php
				...
				<td colspan="6" class="actions">
					...
					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon flex middle-xs">
							...
							<label for="coupon_code"><?php _e( 'Coupon:', 'claue' ); ?></label> <input type="text" name="coupon_code" class="input-text br__40" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'claue' ); ?>" /> <input type="submit" class="button" name="apply_coupon" value="<?php esc_attr_e( 'Apply Coupon', 'claue' ); ?>" />

							<?php do_action( 'woocommerce_cart_coupon' ); ?>
						</div>
					<?php } ?>

					<input type="submit" class="button update-cart" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'claue' ); ?>" />
