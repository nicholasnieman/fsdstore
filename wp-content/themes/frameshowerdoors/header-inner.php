	...
	<head>
        ...
        <script type="text/javascript">
            (function (a, e, c, f, g, h, b, d) {
                var k = {ak: "986686799", cl: "IkYvCPaftnsQz8q-1gM", autoreplace: "855-483-1977"};
                a[c] = a[c] || function () {
...
<!-- END Google Code -->
	...
	<body <?php body_class(); ?> onload="_googWcmGet('number', '855-483-1977')">
				  ...
				  <div style="min-height:auto;" id="main" class="container custom-min-height">
					...
					<div class="col-sm-7 col-md-col-7">
				      <div class="flag_text"> <img class="navFlag" src="<?php echo get_template_directory_uri(); ?>/images/usa-header.png">
				        <p><em>Always Buy American</em> <span> | </span> Call For a <strong>FREE</strong> Quote Today <span class="number"><strong>855.372.6537</strong></span></p>
				      </div>
				    </div>
