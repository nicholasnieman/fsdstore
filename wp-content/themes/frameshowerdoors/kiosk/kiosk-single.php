		                            ...
		                            foreach ($standard_hf_order as $key => $value) {
		                                $src = strtolower( trim( preg_replace('/\s+/', '', $value ), '.') ); 
		                             	...
		                             	if($hinge_style){
											...
											<label>
											<a data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="E" dat-cur-rel="D" rel="'.$value.'" onclick="kiosk_finish(this);">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" />
											</a>
											<a class="btn-v-tild" data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="E" dat-cur-rel="D" rel="'.$value.'"  onclick="kiosk_finish(this);"><span class="post-title-sect coName">'.$value.'</span></a>
											</label></li>';
		                            	}
		                                else{
		                                  	if($check_towelbar == 'on'){
			                                   echo  '<li class="glass-type">
			                                      <label>
			                                         <a data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="N" dat-cur-rel="D" rel="'.$value.'" onclick="kiosk_finish(this);">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" />
			                                         </a>
			                                          <a class="btn-v-tild" data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="N" dat-cur-rel="D" rel="'.$value.'" onclick="kiosk_finish(this);"><span class="post-title-sect coName">'.$value.'</span></a>
			                                      </label></li>';
		                                	}else{
			                                   echo '<li class="glass-type">
			                                      <label>
			                                         <a data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="R" dat-cur-rel="D" rel="'.$value.'" onclick="kiosk_finish(this);">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" />
			                                         </a>
			                                          <a class="btn-v-tild" data-re_keyname="hardware_finish" data-show_keyname="Hardware Finish" rel="'.get_template_directory_uri().'/images/bundled/'.$src.'.png" title="'.$value.'" data-rel="R" dat-cur-rel="D" rel="'.$value.'" onclick="kiosk_finish(this);"> <span class="post-title-sect coName">'.$value.'</span></a>
			                                      </label></li>';
		                                	}
		                                }
		                        	}
			                                    ...
			                                    if($check_pull == 'on'){
                                                    ...
                                                    if($is_olexis == "1" || strtolower($product_line) == 'sebastian'){
														...
														<label style="margin-top:40px !important;">
														 <a data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="F" dat-cur-rel="E" rel="'.$value.'">'.$value.'<img src="'.get_template_directory_uri().'/images/bundled/slidingdoor/'.$src.'.png" style="width: 100%; padding:20px;" /> </a>
														<a class="btn-v-tild" data-re_keyname="hinge_style" data-show_keyname="Style" title="'.$value.'" data-rel="F" dat-cur-rel="E" rel="'.$value.'"> <span class="post-title-sect coName">'.$value.'</span></a>
														</label></li>';
                                                    }else{
                                                        $hinge_style_html .= '<li class="glass-type" style="display:none;">
			                                          <label>
     ...
     <td style="color:#333333;background:#ffffff;padding:4px !important;  font-size:14px;">36"</td>
                 ...
                 <div class="circlef"  style="height:0px; bottom:0px;"><img src="/wp-content/uploads/2016/08/F.png" /></div>
                            <h1>How Would You Like to Open Your Door?</h1>
                                    <?php
                                    if($is_olexis == 1){
                                        echo '<p style="margin-bottom:0px; color:#000000; font-size:18px;">The 8" Ladder Pull handle comes  standard  with the Olexis enclosure.</p>';
                                    }

                                    else if(strtolower($product_line)=='sebastian'){
                                        echo '<p style="margin-bottom:0px; color:#000000; font-size:18px;">The 2" Finger Pull comes standard  with the Sebastian enclosure.</p>';
                                    }
			                    ...
			                    <div class="col-xs-6">
			                       ...
			                       <ul class="bundle-tild-sect" >
                                       ...
                                       ?>
                                           <li style="margin-top:30px !important;">
                                               <label style="width:100% !important">
                                                   <a data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="N" dat-cur-rel="F" rel="" data-re_attr="knob" style="text-align:center !important; margin-bottom:55px;"><img src="/wp-content/uploads/2017/04/BrushNickel-LadderPull-ListingPage.png"  id="olexis_ladder_pull" style="width:180px !important; height:auto;" />
                                                   </a>
                                                   <a class="btn-v-tild" id="knob-attribute-style_a" class="btn-v-tild" data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="N" dat-cur-rel="F" rel="" data-re_attr="knob" style="margin-top: 5px !important; width:250px !important">
                                                       <span class="post-title-sect coNameGreen">Ladder Pull Handle</span>
                                                   </a>
                                               </label>
                                           </li>
                                        <?php
                                       ...
                                       ?>
                                           <li style="margin-top:30px !important;">
                                               <label style="width:100% !important">
                                                   <a data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="N" dat-cur-rel="F" rel="" data-re_attr="knob" style="text-align:center !important; margin-bottom:55px;"><img src="/wp-content/uploads/2017/04/SEBCirChrome.png" id="sebastian_free_knob" style="width:180px !important; height:auto;" />
                                                   </a>
                                                   <a class="btn-v-tild" id="knob-attribute-style_a" class="btn-v-tild" data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="N" dat-cur-rel="F" rel="" data-re_attr="knob" style="margin-top: 5px !important; width:250px !important">
                                       ...
                                       ?>
										<li style="margin-top:30px !important;">
											<label style="width:100% !important">
												<a data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="G" dat-cur-rel="F" rel="" data-re_attr="knob" style="text-align:center !important; margin-bottom:55px;"><img src="https://www.framelessshowerdoors.com/wp-content/uploads/2017/03/upgradeknob-Listingpage.png" id="knob-attribute-style" style="width:180px !important; height:auto;" />Knob
												</a>
										...
										<li class="pull-type" style="margin-top:40px !important;">
										 	<label>
										    	<a data-rel-last="F" data-re_keyname="pull" data-show_keyname="Pull" title="" data-rel="H" dat-cur-rel="F" rel="" style="text-align:center !important; margin-bottom:55px;"><img src="<?php echo get_template_directory_uri(); ?>/images/bundled/handle.png" id="handle-attribute-style" style="width:200px !important; height:auto;"/>Handle
										    	</a>
...
#pricing { display: none;}</style>
 ...
 $(document).ready(function () {
   if(window.location.href.indexOf("FSDShowroom") > -1) {
...
<div id="pricing">
		                          	<h1 style="text-align:center" >Thank you for building your <br>shower door today.
		                          	<span class="glasssqft-options">  Glass SQFT <small></small></span>
		                          	</h1>
		                          	
		                          		<h2 style="color:#333333; text-align:center">Total Material Price: <b>$</b><b id="price_total"></b></h2>
</div>	
