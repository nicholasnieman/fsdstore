...
<head>
	...
	<style type="text/css">
		.bar {
			...
			border-radius: 3px;
			background-image: repeating-linear-gradient( -45deg, #229895, #27A19F 11px, #2CAAAA 10px, #37BABC 20px/* determines size */
			);
		...
		body.blog,
		body.page-template-contractor,
		body.page-template-get-started {
			font-family: "Open Sans", sans-serif;
		...
		.header_area {
			background: #026267;
			/* Old browsers */
			background: -moz-linear-gradient(left, #026267 0%, #65b4b8 100%);
			/* FF3.6-15 */
			background: -webkit-linear-gradient(left, #026267 0%, #65b4b8 100%);
			/* Chrome10-25,Safari5.1-6 */
			background: linear-gradient(to right, #026267 0%, #65b4b8 100%);
			/* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
			filter: progid: DXImageTransform.Microsoft.gradient( startColorstr="#026267", endColorstr="#65b4b8", GradientType=1);
			/* IE6-9 */
			padding-top: 27px;
			padding: 0 15px;
			text-align: left
		...
		.door_type_row .col-md-3,
		.door_type_row .col-md-9 {
			padding-left: 0;
			padding-right: 0;
		}
...
<body id="kiosk_dummy" <?php body_class(); ?>>
			...
			<div class="kiosk">
				...
				<div class="modal-content ">
					...
					<div class="modal-body">
						...
						<img src="/wp-content/themes/frameshowerdoors/kiosk/images/buyingprocess.png" style="width:90%"/>
						...
						<div style="text-align:left;"> <img src="/wp-content/uploads/2016/06/kioskdan.png" style="float:right; padding-left:15px;">
							...
							<p style="font-size:21px; line-height:28px"><strong>Your personal technician will provide:</strong>
							</p>
							...
							<p style="color:#05646a; font-size:21px; line-height:28px;"> Your personal technician will be available anytime you need them, <strong>from measure to install... we've got your back. </strong>
							</p>
					...
					<div class="modal-body">
						...
						<div class="text-left">
							...
							<div class="col-md-12" style="padding:0px !important; list-style-position: inside;">
								...
								<br>
								<p style="font-size:25px; line-height:30px;"><strong>Stay</strong><strong style="color:#5cc5c9">CLEAN</strong>&#8482; Protective glass is available on all of our <strong>Installation</strong><strong style="color:#5cc5c9">EASY</strong>&#8482; shower doors.</p> <br>
								<p style="font-size:25px; line-height:30px;">The benefits of our <strong>Stay</strong><strong style="color:#5cc5c9">CLEAN</strong>&#8482; glass is water and oil repellant resulting in:</p> <br>
		...
		<div class="modal-dialog">
			...
			<div class="kiosk">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<p style="text-align:left; margin-bottom:25px; font-size:21px; line-height:28px;">For over 25 years we have designed, shipped or installed custom glass frameless shower door enclosures for homeowners and contractors all over the globe. In addition to manufacturing our own line of frameless shower door enclosures, we offer our exclusive <strong>Stay<span style="color:#5cc5c9">CLEAN</span></strong>™ protective glass and DIY <strong>Installation<span style="color:#5cc5c9">EASY</span>™</strong> program. <br><br> The Original Frameless Shower Doors is committed to providing fast and courteous service while offering affordable custom shower and bathtub enclosures that fit perfectly in every opening at standard door prices.

						</p>

						<img src="<?php bloginfo('template_url'); ?>/kiosk/images/grouppict.jpg" width="100%">

						<p style="text-align:left; font-size:28px;margin-top:25px; margin-bottom:25px;color:#05646a;"><strong>We are changing the way buying a shower door is done.&#8482; </strong><br>
						</p>

						<div class="col-md-6">
							<ul style="list-style:square; text-align: left; font-size:18px; line-height:28px;">
								<li>Unparalleled Technical Support</li>
								<li>Zero Fabricatione</li>
						...
						<div class="col-md-6">
							...
							<ul style="list-style:square; text-align: left; font-size:18px; line-height:28px;">
								<li>Easy-to-follow DIY Online Resources</li>
								<li>Fastest turnaround in the industry</li>
							</ul>
						</div>
					...
					<div class="modal-body">
						<div class="container">
							...
							<div class="owl-carousel owl-theme text-left" id="designtips">
								<div class="item">
									<p class="text-left" style="margin-bottom:15px; font-size:16px; color:#1f8f96"><em><img src="/wp-content/themes/frameshowerdoors/kiosk/images/fingerpointer.png" width="60"  style="width:60px !important;"> <strong>Swipe left to view next tip</strong></em>
									</p>
				...
				<div class="col-md-6">
					<div class="header_main">
						<div class="header_logo">
							<img src="/wp-content/uploads/2016/08/KioskFrameless_logo.png" width="70%" alt="Logo">
							<p style="margin-top:15px;">
								America's only buy direct from the manufacturer frameless <br> shower door company.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6" style="margin-left:auto; padding-top: 27px;">
					<div class="monkey" style="width:85%; float:right"><img src="/wp-content/uploads/2016/06/InstallationEASY.png" style="margin-right: 18px;
width: 95% !important;
margin-left: -36px;
margin-bottom: 10px;"/>
						<p style="color: #fff; font-size: 14px; line-height: 18px; margin-top: -7px;">
							<strong>From measure to install, we've got your back.</strong><br> Our Installation<strong>EASY</strong>&#8482; program gives you the control of easily designing and installing your own frameless shower doors.
						</p>
					</div>

					<a href="/fdkiosk/kiosk/?FDLocation=<?php if($cityname){ echo $cityname; } ?>&56_temp=<?php echo $discount_kiosk; ?>" style="color:#fff; font-weight:700; text-decoration:none;" class="topbutton">
						<div class="buttonSH" style="width:80%; float:right;  margin:28px auto;  font-size:22px; text-align:center;   background:#f4870b; border:1px solid #e67307; box-shadow: 3px 3px 5px #333333;  padding:25px;"> <i class="fa fa-refresh"></i> CHANGE DOOR SELECTION</div>
					</a>
					<div class="bar2">
						<div class="bartext2">LOADING...</div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row" style="padding:0px !important; margin:0px !important;">
				<div class="header_menu_main">
					<ul class="header_menu">
						<li class="poplinks">
							<a href="javascript:void(0)" rel="#warranty" data-toggle="modal">
								<div class="linkspace"><i class="fa fa-user" aria-hidden="true"></i> &nbsp; About Us</div>
							</a>
						</li>
						<li class="poplinks">
							<a href="javascript:void(0)" rel="#contractor" data-toggle="modal">
								<div class="linkspace"><i class="fa fa-cogs" aria-hidden="true"></i> &nbsp; BUYING PROCESS</div>
							</a>
						</li>
						<li class="poplinks">
							<a href="javascript:void(0)" rel="#clean" data-toggle="modal">
								<div class="linkspace"><i class="fa fa-tint" aria-hidden="true"></i> &nbsp; STAY<span style="font-weight:700">CLEAN</span>&#8482; GLASS</div>
							</a>
						</li>
						<li class="poplinks">
							<a href="javascript:void(0)" rel="#design" data-toggle="modal" style="width:100%">
								<div class="linkspace"><i class="fa fa-paint-brush" aria-hidden="true"></i> &nbsp; DESIGN TIPS </div>
							</a>
						</li>
						<li class="poplinks">
							<a href="javascript:void(0)" rel="#gallery" data-toggle="modal">
								<div class="linkspace"><i class="fa fa-picture-o" aria-hidden="true"></i> &nbsp; Gallery </div>
							</a>
						</li>
					</ul>
				</div>
