...
if ( $framework == 'builder' ) {
	if ( is_user_logged_in() ) {
		...
		if ( $current_user_role == 'sales_rep' || $current_user_role == 'administrator' || $current_user_role == 'franchisee' ) {
...
?>
    ...
    <style type="text/css">
        #kiosk .install_sec #bun_submit {
            background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #e57206 0%, #f78f20 50%, #f48200 51%, #f49a33 100%) repeat scroll 0 0;
    ...
    <div id="get_modal" class="get_modal" style="display:none;">
        <center>
            <div class=" col-md-12">
                ...
                <h2> Protect your shower glass with our <span style="font-weight: 400;">STAY</span><span
                            style="font-weight: bold;">CLEAN</span><span>&trade;</span> water and stain resistant Glass.
                </h2>
                <div class="stay_clean_glass" class="col-xs-12 stc-option" style="text-align:center">
                    <div class="row option-text" style="text-align:center !important">
	                  	<span>
	                      	...
	                      	<br>Add
	                      	water and stain resistant glass NOW for only $<span
                                    class="coating-price-defined"><?php echo $resistant_coating; ?></span>
	                      	<center>
    ...
    <div class="single-tild-sect">
        ...
        <div id="stepNavigation">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="invalid range" id="thePrice">
                    ...
                    <div class="twoColbg" id="<?php echo get_the_id(); ?>">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div id="attribute-option-1" class="attribute-glass_sqft build-showerdoor activebt">
                                ...
                                <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                    Please enter your approximate measurements rounded off to the nearest inch.<br>
								...
								if ( have_posts() ) :
									while ( have_posts() ) : the_post();
										...
										for ( $i = 0; $i < $glass_sqft; $i ++ ) {
											$html .= '<p><label class="measurements">' . range( 'A', 'Z' )[ $i ] . '</label><input type="text" pattern="[0-9]*" inputmode="numeric" required="" data-rel="' . range( 'A', 'Z' )[ $i ] . '" name="option-qty" id="fsd-doorbuilder-option-21-qty-[' . $i . ']" onkeypress="return event.charCode >= 46 && event.charCode <= 57 && event.charCode != 47 || event.charCode <= 9" class="measurement pasteup"><span class="inches">inches</span><span class="error"></span></p>';
										}
								...
								echo '</div>';
									...
									if ( $standard_door_width == 'on' ) { ?>
                                        <div id="attribute-option-1"
                                             class="field-_attribute_tag build-showerdoor attribute-std_dr_width atribut-pull_h">
                                            <div class="col-xs-12">
                                                <ul class="bundle-tild-sect">
                                                    <li class="glass-type">
                                                        <label>
                                                            <a data-re_keyname="standard_door_width"
                                                               data-show_keyname="Door Width" data-show_keypara="54"
                                                               rel="<?php echo get_template_directory_uri(); ?>/images/no_selection.gif"
                                                               title="54" data-rel="attribute-option-2"
                                                               dat-cur-rel="attribute-option-1" rel='54'>54" to 59
                                                                1/2"<img
                                                                        src="<?php echo get_template_directory_uri(); ?>/images/no_selection.gif"/>
                                                            </a>
                                                            <a class="btn-v-tild" data-re_keyname="standard_door_width"
                                                               data-show_keypara="54" data-show_keyname="Door Width"
                                                               rel="<?php echo get_template_directory_uri(); ?>/images/no_selection.gif"
                                                               title='54' data-rel="attribute-option-2"
                                                               dat-cur-rel="attribute-option-1" rel='54'><span
                                                                        class="post-title-sect coName">54" to 59 1/2"</span></a>
                                                        </label>
                                                    </li>
                                                </ul>
                                            </div>
								...
								<?php if ( $glass_thickness ) { ?>
                                    <div id="attribute-option-2"
                                         class="field-_attribute_tag attribute-glass_thickness build-showerdoor atribut-pull_h dependence">
                                    <div class="col-xs-12">
                                        <h1>Please Choose Your Glass Thickness </h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Depending on your glass choice, ½" glass may not be available.
                                        </div>
		                     ...
		                     <div class="col-xs-12">';
                                ...
                                <!-- Glass type Section -->
                                <div id="attribute-option-3"
                                     class="field-_attribute_tag attribute-glass_type build-showerdoor atribut-gls_h">
                                    <div class="col-xs-12">
                                        <h1>Select Your Glass Type </h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Note: Clear Glass is the most commonly used and least expensive glass.Clear
                                            Low-Iron Glass, Colored Glass, or any Textured or Obscured Glass are more
                                            expensive than traditional clear glass. Rain, Bubbles, Aquaview and Crepe
                                            only come in 3/8" thickness.
                                        </div>
                                        <ul class="bundle-tild-sect">
											<?php
								...
								?>
                                <div id="attribute-option-4"
                                     class="field-_attribute_tag <?php echo $ajax_class; ?> build-showerdoor atribut-gls_h dependence"
                                     data-re_attr="<?php echo $re_attr; ?>">
                                    <div class="col-xs-12">
                                        <h1>Select Your Hardware Finish</h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Note: Some finishes may delay turnaround time.
                                        </div>
                                ...
                                <!-- Hinge Style Section -->
								<?php if ( $hinge_style ) { ?>
                                    <div id="attribute-option-5"
                                         class="field-_attribute_tag attribute-glass_hingestyle build-showerdoor atribut-gls_h"
                                         data-re_attr="hinge">
                                        <div class="col-xs-12">
                                            <h1>What Style of Hardware Do You Prefer? </h1>
                                            <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                                Note: Header enclosures only come with a square header and hinges
                                            </div>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="measurements-text">
                                                <img src="<?php bloginfo( 'template_url' ); ?>/images/Specs-2.jpg"
                                                     class="img-big">
                                            </div>
                                        </div>
                                    </div>
								...
								<?php if ( $check_pull == 'on' ) { ?>
                                    <!-- Pull Section -->
                                    <div id="attribute-option-6" data-spec-id="attribute-option-6"
                                         class="field-_attribute_tag attribute-glass_pulltype build-showerdoor atribut-pull_h">
                                        <div class="col-xs-12">
                                            ...
                                            <ul class="bundle-tild-sect">
												...
												if ( $is_olexis == 1 ) {
                                                    ...
                                                    <li class="pull-type">
                                                        <label>
                                                            <a data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                               data-show_keyname="Pull" title=""
                                                               data-rel="attribute-option-13a"
                                                               dat-cur-rel="attribute-option-6" rel=""
                                                               data-re_attr="knob"><img
                                                                        src="/wp-content/uploads/2017/04/BrushNickel-LadderPull-ListingPage.png"
                                                                        id="olexis_ladder_pull" style="height: 100px;"/>
                                                            </a>
                                                            <a class="btn-v-tild" id="knob-attribute-style_a"
                                                               data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                               data-show_keyname="Pull" title=""
                                                               data-rel="attribute-option-13a"
                                                               dat-cur-rel="attribute-option-6" rel=""
                                                               data-re_attr="knob">
                                                    ...
                                                    <li class="pull-type">
                                                        <label>
                                                            <a data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                               ...
                                                               dat-cur-rel="attribute-option-6" rel=""
                                                               data-re_attr="knob"><img
                                                                        src="https://www.framelessshowerdoors.com/wp-content/uploads/2017/03/BrushNickel-LadderPull-ListingPage.png"
                                                                        id="sebastian_free_knob"
                                                                        style="height: 100px;"/>
                                                            </a>
                                                            <a class="btn-v-tild" id="knob-attribute-style_a"
                                                               data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                ...
                                                <li class="pull-type">
                                                    <label>
                                                        <a data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                           data-show_keyname="Pull" title=""
                                                           data-rel="attribute-option-7"
                                                           dat-cur-rel="attribute-option-6" rel=""
                                                           data-re_attr="knob"><?php
															if ( $is_olexis == 1 ) {
																?>
                                                                <img src="https://www.framelessshowerdoors.com/wp-content/uploads/2017/03/upgradeknob-Listingpage.png"
                                                                     id="knob-attribute-style"/><?php } else {
																?><img
                                                                src="<?php echo get_template_directory_uri(); ?>/images/bundled/knob.png"
                                                                id="knob-attribute-style"/><?php
															} ?>Knob
                                                        </a>
                                                        <a class="btn-v-tild" id="knob-attribute-style_a"
                                                           data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                           data-show_keyname="Pull" title=""
                                                           data-rel="attribute-option-7"
                                                           dat-cur-rel="attribute-option-6" rel="" data-re_attr="knob">
                                                            <span class="post-title-sect coName">Knob<?php if ( $is_olexis == 1 || strtolower( $product_line ) == 'sebastian' ) {
		                                                            echo " Upgrade";
	                                                            } ?></span>
                                                        </a>
                                                    </label>
                                                ...
                                                <li class="pull-type">
                                                    <label>
                                                        <a data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                           data-show_keyname="Pull" title=""
                                                           data-rel="attribute-option-8"
                                                           dat-cur-rel="attribute-option-6" rel=""><img
                                                                    src="<?php echo get_template_directory_uri(); ?>/images/bundled/handle.png"
                                                                    id="handle-attribute-style"/>Handle
                                                        </a>
                                                        <a class="btn-v-tild" data-rel-last="attribute-option-6"
                                                           data-re_keyname="pull" data-show_keyname="Pull" title=""
                                                           data-rel="attribute-option-8"
                                                           dat-cur-rel="attribute-option-6" rel="">
                                                            <span class="post-title-sect coName">Handle<?php if ( $is_olexis == 1 || strtolower( $product_line ) == 'sebastian' ) {
		                                                            echo " Upgrade";
	                                                            } ?></span>
                                                        </a>
                                                    </label>
												...
												if ( $omit_combo_bar != 1 ) {
                                                    ...
                                                    <li class="pull-type">
                                                        <label>
                                                            <a data-rel-last="attribute-option-6" data-re_keyname="pull"
                                                               data-show_keyname="Pull" title=""
                                                               data-rel="attribute-option-10"
                                                               dat-cur-rel="attribute-option-6" rel=""><img
                                                                        src="<?php echo get_template_directory_uri(); ?>/images/bundled/towelbarcombo.png"
                                                                        id="towelbar-attribute-style"/>Towel Bar
                                                            </a>
                                                            <a class="btn-v-tild" data-rel-last="attribute-option-6"
                                                               data-re_keyname="pull" data-show_keyname="Pull" title=""
                                                               data-rel="attribute-option-10"
                                ...
                                <!-- Pull Section knob -->
                                <div id="attribute-option-7" data-spec-id="attribute-option-6"
                                     class="atribut-pull_style field-_attribute_tag attribute-knob_style build-showerdoor atribut-pull_h knob_style"
                                     data-re_attr="knob">
                                    <div class="col-xs-12">
                                        <h1>Choose Your Knob Style</h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Some finishes displayed below may not appear to be the exact color you've
                                            chosen, rest assured all of your hardware and pull type will match the
                                            selected finish.
                                        </div>
                                ...
                                <div id="attribute-option-8" data-spec-id="attribute-option-6"
                                     class="atribut-pull_style field-_attribute_tag attribute-handle_size build-showerdoor atribut-pull_h handle_size">
                                    <div class="col-xs-12">
                                ...
                                <div id="attribute-option-9"
                                     class="atribut-pull_style field-_attribute_tag attribute-handle_style build-showerdoor atribut-pull_h atribut-gls_h handle_style"
                                     data-re_attr="handle">
                                    <div class="col-xs-12">
                                        <h1>Choose Your Handle Style</h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Some finishes displayed below may not appear to be the exact color you've
                                            chosen, rest assured all of your hardware and pull type will match the
                                            selected finish.
                                ...
                                <div id="attribute-option-10" data-spec-id="attribute-option-6"
                                     class="atribut-pull_style attribute-towelbar_size build-showerdoor atribut-pull_h atribut-gls_h towelbar_size">
                                    <div class="col-xs-12">
                                ...
                                <div id="attribute-option-11"
                                     class="atribut-pull_style field-_attribute_tag attribute-towelbar_size build-showerdoor atribut-pull_h atribut-gls_h towelbar_size">
                                    <div class="col-xs-12">
                                ...
                                <div id="attribute-option-12"
                                     class="att-tild-sect atribut-pull_style field-_attribute_tag attribute-towelbar_style build-showerdoor atribut-pull_h atribut-gls_h towelbar_style"
                                     data-re_attr="handle-towelbar-combo">
                                    <div class="col-xs-12">
                                        <h1>Choose Your Combo Towelbar Style </h1>
                                        <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                            Some finishes displayed below may not appear to be the exact color you've
                                            chosen, rest assured all of your hardware and pull type will match the
                                            selected finish.
								...
								<?php if ( $check_towelbar == 'on' ) { ?>
                                    ...
                                    <div id="attribute-option-13a"
                                         class="attribute-glass_installation build-showerdoor show-attribute-combo field-_attribute_tag atribut-pull_h atribut-gls_h">
                                        <div class="col-xs-12">
                                            <ul class="bundle-tild-sect">
                                                <li class="">
                                                    <label>
                                                        <a title="No" data-re_keyname="no_comboo"
                                                           data-show_keyname="Towel Bar" title="No"
                                                           data-rel="attribute-option-13e"
                                                           dat-cur-rel="attribute-option-13a">
                                                            <img alt="No"
                                                                 src="<?php echo get_template_directory_uri(); ?>/images/no.png"
                                                                 style="height: 320px;">No
                                                        </a>
                                                        <a class="btn-v-tild" title="No" data-re_keyname="no_comboo"
                                                           data-show_keyname="Towel Bar" title="No"
                                                           data-rel="attribute-option-13e"
                                                           dat-cur-rel="attribute-option-13a">
                                                ...
                                                <li class="active">
                                                    <label>
                                                        <a class="yes_towelbar_attr" title="Yes"
                                                           data-re_keyname="no_comboo" data-show_keyname="Towel Bar"
                                                           title="Yes" data-rel="attribute-option-13b"
                                                           dat-cur-rel="attribute-option-13a">
                                                            <img alt="Yes"
                                                                 src="<?php echo get_template_directory_uri(); ?>/images/yes.png"
                                                                 style="height: 320px;">Yes
                                                        </a>
                                                        <a class="yes_towelbar_attr btn-v-tild" title="Yes"
                                                           data-re_keyname="no_comboo" data-show_keyname="Towel Bar"
                                                           title="Yes" data-rel="attribute-option-13b"
                                                           dat-cur-rel="attribute-option-13a">
                                    ...
                                    <!--  Towelbar Size -->
                                    <div id="attribute-option-13b"
                                         class="attribute-glass_combo field-_attribute_tag attribute-handle-combo-towelbar_size build-showerdoor atribut-pull_h atribut-gls_h towelbar_size">
                                        <div class="col-xs-12">
                                    ...
                                    <!-- Towelbar Sides -->
                                    <div id="attribute-option-13c"
                                         class="attribute-glass_combo field-_attribute_tag attribute-handle-combo-towelbar_side build-showerdoor atribut-pull_h atribut-gls_h towelbar_side">
                                        <div class="col-xs-12">
                                    ...
                                    <!-- Towelbar Style -->
                                    <div id="attribute-option-13d"
                                         class="attribute-glass_combo field-_attribute_tag attribute-handle-combo-towelbar_style build-showerdoor atribut-pull_h atribut-gls_h towelbar_style"
                                         data-re_attr="towelbar">
                                        <div class="col-xs-12">
                                            <h1>Choose your combo towelbar style </h1>
                                            <div style="font-size:14px; font-style:italic; padding-bottom:15px; color:#333333 !important">
                                                Some finishes displayed below may not appear to be the exact color
                                                you've chosen, rest assured all of your hardware and pull type will
                                                match the selected finish.
                                            </div>
                                            <ul class="bundle-tild-sect"> <?php
												if ( $towelbar_style ) {
                                ...
                                <div id="attribute-option-13e"
                                     class="build-showerdoor attribute-glass_installation atribut-pull_h atribut-gls_h">
                                    ...
                                    <div class="form-left">
                                        <div class="light-well well text-center">
                                            <div id="starburst">
                                                ...
                                                <h2>
                                                    <nobr>F&D Discounted Price: <b>$</b><b id="fd_total"></b></nobr>
                                                </h2>
                                                <h2>
                                                    <nobr>Total Material Price: <b>$</b><b id="price_total"></b></nobr>
                                                </h2>

                                                <h2 style="margin: 0px;">
                                                    <nobr><a href="javascript:void(0)" rel="calci-dist" id="calci-dist"
                                                             class="discount_section_attr">+</a></nobr>
                                                </h2>
                                                    ...
                                                    <div class="row dist-tild-sec">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-6 dist-stayclean-sec">
                                                                <div class="custom-input-group custom-info">
                                                                    <input type="number" min="1" max="70"
                                                                           name="additiona_quote1" id="dfi_disocunt_txt"
                                                                           value="" placeholder="StayCLEAN"
                                                                           onkeypress="return event.charCode >= 46 && event.charCode <= 57 && event.charCode != 47 || event.charCode <= 9"/>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 dist-door-sec">
                                                                <div class="custom-input-group custom-info">
                                                                    <input type="number" min="1" max="70" name="Door"
                                                                           id="door_disocunt_txt" value=""
                                                                           placeholder="Door"
                                                                           onkeypress="return event.charCode >= 46 && event.charCode <= 57 && event.charCode != 47 || event.charCode <= 9"/>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="additional_charge_sect">
                                                                    <div class="custom-input-group custom-info">
                                                                        <input type="number" min="1" max="100"
                                                                               name="additional_charge_fld"
                                                                               id="door_additional_txt" value=""
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-12 dist-door-sec">
                                                                <div class="custom-input-group custom-info">
                                                                    <a href="javascript:void(0)" class="coName"
                                                                       id="calculate-discount-door">Calculate</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="calci-dist-door" style="display: none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="custom-input-group custom-info">
                                                                <p id="staycln-dis-total" class="hide-tild-sect">
                                                                    StayClean: <span></span></p>

                                                                <p id="appr-disct" class="hide-tild-sect"
                                                                   style="color:red;"> StayClean Discount: <span></span>
                                                                </p>

                                                                <p id="final-stayclean-dis" class="hide-tild-sect">
                                                                    StayClean Total: <span></span></p>

                                                                <p id="no-stayclean-dis" class="hide-tild-sect">DFI
                                                                    option not selected! </p>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="custom-input-group custom-info">
                                                                <p id="door-dis-total" class="hide-tild-sect"> Door
                                                                    Price: <span></span></p>

                                                                <p id="door-disct" class="hide-tild-sect"
                                                                   style="color:red;"> Door Discount: <span></span></p>

                                                                <p id="final-door-dis" class="hide-tild-sect"> Door
                                                                    Total: <span></span></p>
                                                ...
                                                <table id="discount-til-sect" style="display:none;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100" align="left"><span
                                                                    class="total_price empty_sect">1200</span></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="100" align="left"><span
                                                                    class="final_price empty_sect">1000</span></td>
                                                    </tr>
                                                    ...
                                                    <div class="install_form clearfix" id="form_secarea">
                                                        <div class="install_sec">
                                                            <div class="formLayout">
                                                                <form action="<?php echo $form_redirect_url; ?>"
                                                                    ...
                                                                    <input type="hidden"
                                                                           ...
                                                                           name="oid">
                                                                    <input type="hidden"
                                                                           value="Frameless Shower Door - <?php echo get_the_title(); ?>"
                                                                           id="description" name="description">
                                                                    <input type="hidden" value="" id="i_doortype"
                                                                           name="i_doortype">
                                                                    <input type="hidden" value="Door Builder"
                                                                           name="lead_source">
                                                                    <input type="hidden" name="price" id="priceinput"
                                                                           value="">
                                                                    <input type="hidden" name="sqft" id="sqftinput"
                                                                           value="">
                                                                    <input type="hidden" name="sqftclean" id="sqftclean"
                                                                           value="">


                                                                    <input type="hidden" value="0" id="stayclean"
                                                                           name="stayclean" class="staycleaninput">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="custom-input-group build-showerdoor custom-info">
                                                                                <h4 style="color: #333;">Sales Member
                                                                                    Information</h4>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group custom-info">
                                                                                ...
                                                                                <input type="text"
                                                                                       name="phone_number_sales"
                                                                                       id="phone_number_sales"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <select name="state" id="state" required class="input-filed">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text" name="sales_shipping"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text" name="sales_crating"
                                                                                       placeholder="Crating"
                                                                                       id="sales_crating">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <textarea wrap="soft"
                                                                                          ...
                                                                                          class="form-control input input-filed"></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       ...
                                                                                       name="custom_hardware1_label"
                                                                                       placeholder="Label"
                                                                                       id="custom_hardware1_label">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       name="custom_hardware1_val"
                                                                                       placeholder="Price"
                                                                                       id="custom_hardware1_val">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       style="background:#cccccc;"
                                                                                       name="custom_hardware2_label"
                                                                                       placeholder="Label"
                                                                                       id="custom_hardware2_label">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       name="custom_hardware2_val"
                                                                                       placeholder="Price"
                                                                                       id="custom_hardware2_val">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       style="background:#cccccc;"
                                                                                       name="custom_hardware3_label"
                                                                                       placeholder="Label"
                                                                                       id="custom_hardware3_label">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       name="custom_hardware3_val"
                                                                                       placeholder="Price"
                                                                                       id="custom_hardware3_val">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       style="background:#cccccc;"
                                                                                       name="custom_hardware4_label"
                                                                                       placeholder="Label"
                                                                                       id="custom_hardware4_label">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="custom-input-group">
                                                                                <input type="text"
                                                                                       name="custom_hardware4_val"
                                                                                       placeholder="Price"
                                                                                       id="custom_hardware4_val">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="col-md-6">
                                                                                <div class="custom-input-group for_outsidesales custom-info">
                                                                                    ...
                                                                                    <input type="radio"
                                                                                           name="for_outsidesales"
                                                                                           id="for_outsidesales"
                                                                                           value="outsidesale"/>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="custom-input-group for_texas custom-info">
                                                                                    <label>Outside Certified Installers
                                                                                        Sales</label>
                                                                                    <input type="radio"
                                                                                           name="for_outsidesales"
                                                                                           id="for_texas"
                                                                    ...
                                                                    <input type="hidden"
                                                                           ...
                                                                           id="stayclean" name="currentuser">
                                                                    <input type="hidden"
                                                                           value="<?php echo $mode_type; ?>"
                                                                           id="stayclean" name="mode_type">
                                                                    <input type="hidden" value="<?php echo $cur_url; ?>"
                                                                           id="cur_url" name="website">
                                                                    <input type="hidden" value="" id="additional_sectt"
                                                                           name="additional_sectt">


                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="custom-input-group build-showerdoor"
                                                                                 style="display:block!important;">
                                                                                <a href="javascript:void(0)"
                                                                                   id="download_pdf_crm" class="coName">Download
                                                                                    (No CRM)</a>
                                                                                <input type="submit"
                                                                                       name="contactSubmit"
                                                                                       value="Submit" id="bun_submit"
                                                                                       class="coName">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="total_vall">
                                            <div id="priceItem" class="col-xs-12 recapItem priceItem"
                                                ...
                                                <div class="list-group recap-list">
                                                    <div class="col-xs-12">
                                                        <h4 class="list-group-item-heading count title">Your Shower Door
                                                            Configuration</h4>
                                                    </div>
                                                </div>
                                                <div id="door_txt" style="display: none;"
                                                     data-re_atr="<?php echo $discount_txt; ?>">4
                                                </div>
                                                <div id="door_description" style="display: none;"
                                                     data-re_atr="<?php echo $discount_description; ?>">2
                                                </div>
                                                <div id="door_button_dis" style="display: none;"
                                                     data-re_atr="<?php echo $hide_discount_opt; ?>">2
                                                </div>
                                            </div>

                                            <div class="sqft_gls">
                                                <ul>
                                                    <li><span class="option_head"></span><span
                                                                class="options_price"></span></li>
                                                </ul>
                                            </div>
