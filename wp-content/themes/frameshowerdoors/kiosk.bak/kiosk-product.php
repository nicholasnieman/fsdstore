...
<script type="text/javascript">
    ...
    if(url.includes('PompanoFLKiosk'))    //includes() method determines whether a string contains specified string.
    {
         jQuery('#pompano').css('display','block');
		 jQuery('#wpfl').css('display','none');
    }
		 if(url.includes('WPFL'))    //includes() method determines whether a string contains specified string.
    {
         jQuery('#wpfl').css('display','block');
		  jQuery('#pompano').css('display','none');
    }
