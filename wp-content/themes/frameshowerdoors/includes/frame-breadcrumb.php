...
class frame_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<div class="cont_nav"><div class="cont_nav_inner"><p><a href="' . site_url() . '/">Home</a>';
        ...
        echo "<span> | The Original Frameless Shower Doors </span></p></div></div>";
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'frameshower') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'frameshower') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'frameshower');

        }

		if (is_404()) {            return __('Error 404', 'frameshower');        }
...
$frame_breadcumb = new frame_breadcrumb_class();
