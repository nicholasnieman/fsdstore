...
function testiominal_code()
{
    ...
    echo "<div id='crmWebToEntityForm'>
				  ...
				  <form action='https://crm.zoho.com/crm/WebToLeadForm' name='WebToLeads1429722000001420005' method='POST' onSubmit='javascript: return checkMandatoryField()' accept-charset='UTF-8'>		   
        ...
        while (have_posts()) : the_post();
            if (get_field('_meta_bxx_section1', get_the_id())):
                while (has_sub_field('_meta_bxx_section1', get_the_id())):
                    if (get_sub_field('_cont_blk')):
                        while (has_sub_field('_cont_blk')):
                            ...
                            echo '<div class="col-md-3 col-sm-3 margin-bottom-20 align-center">
										<a href="' . get_sub_field('_href_bxxx') . '"> 
										<img src="' . $img_url['url'] . '" alt="' . $img_url['alt'] . '" />
                    ...
                    echo '<div class="col-md-12">' . get_sub_field('_content_block_bxx') . ' </div>';
                endwhile;
            endif;
        endwhile;
    endif;
...
function category_listing()
{
    ...
    foreach ($wcatTerms as $wcatTerm) {
        ...
        if ($wcatTerm->term_id == 101) {
            ...
            <a class="btn-v4 fullwidth inline align-center" id="cat-id-<?php echo $wcatTerm->term_id; ?>"
               href="<?php echo get_term_link($wcatTerm->slug, $wcatTerm->taxonomy); ?>"
               onclick="_gaq.push(['_trackEvent', 'Single-Shower-Door', 'View-All-6-Layouts', 'Single-Shower-Door-Complete']);">View
                All 6 Layouts</a>
            <?php
        } else {
            ?>
            <a id="cat-id-<?php echo $wcatTerm->term_id; ?>"
               href="<?php echo get_term_link($wcatTerm->slug, $wcatTerm->taxonomy); ?>"
               class="btn-v4 fullwidth inline align-center">View All <?php echo $count; ?> Layouts</a>
            <?php
        }
        echo '</div>';
    }
...
function inner_footer()
{
    ...
    echo "<div id='crmWebToEntityForm'>
				   <META HTTP-EQUIV ='content-type' CONTENT='text/html;charset=UTF-8'>
				  <form action='https://crm.zoho.com/crm/WebToLeadForm' name='WebToLeads1429722000001420005' id='WebToLeads1429722000001420005' method='POST' onSubmit='javascript: return checkMandatory()' accept-charset='UTF-8'>		   
    ...
    <script>
        ...
        function checkMandatoryFields() {
            jQuery('#WebToLeads1429722000001420005 *').filter(':input').each(function(){
                var tagName = jQuery(this).attr('name');
                alert(tagName);
            };
            ...
            for (i = 0; i < mndFileds.length; i++) {
                ...
                if (fieldObj) {
                    if (((fieldObj.value).replace(/^\s+|\s+$/g, '')).length == 0) {
                        alert(((fieldObj.value).replace(/^\s+|\s+$/g, '')).length);
...
function installation_kit()
{
 ...
 <div class="col-xs-12">
    <h1>Doing it yourself? Choose an installation kit below</h1>
...
function installation_kit_kiosk()
{
 ...
 <div class="col-xs-12">
  ...
  <tbody>
    <tr>
      <td valign="top" width="230" style="text-align:left !important" > <a data-re_keyname="install_kit" data-show_keyname="Installation Kit" title="no-kit" data_installation="no-installation-kit"  data-rel="S" dat-cur-rel="attribute-option-13" rel="no-kit">No Installation Kit<img src="' . get_template_directory_uri() . '/images/bundled/no-kit.png" />
             </a>
             <a class="btn-v-tild" data-re_keyname="install_kit" data-show_keyname="Installation Kit" title="no-kit" data_installation="no-installation-kit" data-rel="S" dat-cur-rel="attribute-option-13" rel="no-kit">
             <span class="post-title-sect coName">No Installation Kit</span>
             </a></td>
	...
	<td valign="top" style="text-align:left !important; " > <a data-re_keyname="install_kit" data-show_keyname="Installation Kit" title="basic-kit" data_installation="basic-installation-kit" data-rel="S" dat-cur-rel="attribute-option-13" rel="no-kit">basic Installation Kit<img src="' . get_template_directory_uri() . '/images/bundled/basic.png" />
             </a>
             <a class="btn-v-tild" data-re_keyname="install_kit" title="basic-kit" data-show_keyname="Installation Kit" data_installation="basic-installation-kit" data-rel="S" dat-cur-rel="attribute-option-13" rel="Basic">
	...
	<td valign="top" style="text-align:left !important; " id="Complete" > <a data-re_keyname="install_kit" data-show_keyname="Installation Kit" title="complete-kit" data_installation="complete-installation-kit" data-rel="S" dat-cur-rel="attribute-option-13" rel="no-kit">complete Installation Kit<img src="' . get_template_directory_uri() . '/images/bundled/complete.png" />
             </a>
             <a class="btn-v-tild" data-re_keyname="install_kit" data-show_keyname="Installation Kit" title="complete-kit" data_installation="basic-installation-kit" data-rel="S" dat-cur-rel="attribute-option-13" rel="complete">
...
function steam_units()
{
    $steam_units_html = '';
    $steam_units_html = "
    <iframe width='100%' height='560px' frameborder='0' src='https://crm.zoho.com/crm/WebFormServeServlet?rid=9d3bc3a95b188bcc05de1fdd4794542a22fb45bc5d1c27fe1d03b922bc39b2b9gidf6675da4f5b64b7c54aeb859879a87ea594e8fefd20d5f521a0288b1f64c3ca9'></iframe>
    ";
    ?>
    <script>
...
function subct_product_ids($cat_id)
{
    if (has_term_have_children($cat_id)) {
        $subcatid_arr = array();
        $wsub_subargs = array('hierarchical' => 1, 'show_option_none' => '', 'hide_empty' => false, 'parent' => $cat_id, 'taxonomy' => 'product_cat', 'order' => 'ASC');
        $wsub_subcats = get_categories($wsub_subargs);
        foreach ($wsub_subcats as $catskey => $catsvalue) {
            $subcat_title = $catsvalue->name;
            $args = array('post_type' => 'product', 'post_status' => 'publish', 'posts_per_page' => -1, 'tax_query' => array(array('taxonomy' => 'product_cat', 'field' => 'id', 'terms' => $catsvalue->term_id)), 'meta_query' => array(array('key' => 'tinfini_storemetabox', 'value' => 'on', 'compare' => '=',),),);
            ...
            while ($query->have_posts()) :
                ...
                if ($store_grp) {
                    $inner_args = array(
                        ...
                        'post_status' => 'publish',
                        'tax_query' => array(
                            array('taxonomy' => 'product_cat', 'field' => 'id', 'terms' => $catsvalue->term_id,),
