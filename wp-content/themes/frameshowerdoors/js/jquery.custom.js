...
jQuery(document).ready(function(){
    jQuery(".roundup").blur(function(){
        // this is to convert any strings into numeric
    ...
    jQuery(".pasteup").blur(function(){
        // this is to convert any strings into numeric
        // this function was put in place to retain Decimal values.
        ...
        if(isn == true){
            ...
            //this.value=v; // retains decimal
            this.value=p; // currently they want the decimals to round up
        }
    });

    jQuery("input[name='First Name']").keyup(function(){
        var val = jQuery("input[name='First Name']").val();
        var lastSpot = val.length -1;
        var lastChar = val.charAt(lastSpot);
        if(jQuery.isNumeric(lastChar)){
            var res = val.replace(lastChar, "");
            jQuery("input[name='First Name']").val(res);
        }
    });
});
...
function formatPhoneNum(obj,del,parens){
     ...
     * = the delimiter to be used
     ...
     EXAMPLE: onkeyup="formatPhoneNum(this,'-','no')" */
