	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<p style="color: white; font-size:14px !important">America's only direct from the manufacturer frameless shower door company.</p>
			</div>
			<div class="col-md-4" style="margin-left:auto; padding-top: 15px;">
				...
				<div id="selected-layout" class="smalltext text-center" style="display: none; margin-top: 15px;">
                	<?php 
                		if(is_single()){
