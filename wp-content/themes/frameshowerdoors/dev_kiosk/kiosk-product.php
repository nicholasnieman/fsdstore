										...
										if ( $the_queryy->have_posts() ) {
											while ( $the_queryy->have_posts() ) { 
													...
													if( $FDLocation_name != '' && $FDLocation_name != 'null' && $FDLocation_name != 'index'){
														$href= ''.get_permalink().'?mode=dev_kiosk&FDLocation='.$FDLocation_name.'&56_temp='.$discount_kiosk;
													}else if($FDLocation_name == '' && $discount_kiosk != ''){
														$href= ''.get_permalink().'?mode=dev_kiosk&56_temp='.$discount_kiosk;
													}else{
														$href= ''.get_permalink().'?mode=dev_kiosk/';
													}
