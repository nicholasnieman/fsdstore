...
class Woocommerce_Product_Attachment
{
    ...
    public function __construct()
    {
        ...
        add_filter("{$prefix}plugin_action_links_" . WCPOA_PLUGIN_BASENAME, array($this, 'plugin_action_links'), 10, 4);
    }
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('wp_ajax_wcpoa_free_subscribe_newsletter', $plugin_admin, 'wcpoa_free_subscribe_newsletter');
        ...
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'wcpoa_add_meta_box', 10, 9);
...
//        $this->loader->add_filter('woocommerce_account_menu_items', $plugin_public, 'wcpoa_add_link_my_account');
        ...
        $this->loader->add_action('woocommerce_order_details_after_order_table', $plugin_public, 'wcpoa_order_data_show', 1, 2);
        $this->loader->add_action('init', $plugin_public, 'wcpoa_download_file');
        $this->loader->add_filter('woocommerce_email_order_meta_fields', $plugin_public, 'wcpoa_woocommerce_email_order_attachment', 10, 3);
    ...
    public function plugin_action_links($actions, $plugin_file, $plugin_data, $context)
    {
        $custom_actions = array(
            ...
            'premium'   => sprintf('<a href="%s" target="_blank" style="color: rgba(10, 154, 62, 1); font-weight: bold; font-size: 13px;">%s</a>', 'https://store.multidots.com/woocommerce-product-attachment', __('Upgrade To Pro', $this->plugin_name))
        );
