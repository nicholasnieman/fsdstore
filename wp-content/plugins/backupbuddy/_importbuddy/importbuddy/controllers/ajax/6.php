...
if ( NULL === ( $restoreData = json_decode( base64_decode( $restoreData ), true ) ) ) {
	pb_backupbuddy::alert( 'ERROR #83893: unable to decode JSON restore data `' . htmlentities( $restoreData ) . '`. Restore halted.' );
	die();
}
