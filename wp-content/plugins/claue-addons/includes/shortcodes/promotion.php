	...
	function claue_addons_shortcode_promotion( $atts, $content = null ) {
		...
		$output .= '<div class="' . esc_attr( implode( ' ', $classes ) ) . '">';
			...
			$output .= '<div class="pa">';
				...
				if ( $text_2 ) {
					$output .= '<h4 class="mg__0 mb__10" style="' . esc_attr( implode( ' ', $text_2_style ) ) . '">' . esc_html( $text_2 ) . '</h3>';
				}
				if ( $text_3_button ) {
					...
					if ( $text_3 ) {
						$output .= '<h5 class="mg__0" style="' . esc_attr( implode( ' ', $text_3_style ) ) . '">' . esc_html( $text_3 ) . '</h3>';
					}
				}
			$output .= '</div>';
		$output .= '</div>';
