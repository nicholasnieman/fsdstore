...
if ( ! function_exists( 'claue_addons_shortcode_products' ) ) {
	function claue_addons_shortcode_products( $atts, $content = null ) {
		$output = '';
		...
		// Return output
		return apply_filters( 'claue_addons_shortcode_products', force_balance_tags( $output ) );
	}
}