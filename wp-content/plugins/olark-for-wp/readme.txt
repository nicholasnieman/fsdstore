...
Please report any errors you get to me. You can either [post here](http://burningpony.com/blog/index.php/2011/05/olark-wordpress-better-together/) or [contact me directly](http://www.burningpony.com/).

= What if I have questions that are not covered here? =

The best way to get in contact with me is [though my website](http://www.burningpony.com/). Please contact me any time if you have questions, comments, etc. Also, you can leave a comment on [the official Olark for WordPress page](http://burningpony.com/blog/index.php/2011/05/olark-wordpress-better-together).
== Upgrade Notice ==
= Only Wordpress 3.1.2 and Above have been tested. =
== Screenshots ==

1. The Olark for WordPress backend interface
